...
\begin{enumerate}
    \item Find $(\zeta_h, \xi_h) \in V_h \times V_h^0$ given by
     ...
     \end{align}
     where $(\zeta_{,h}, \xi_{0,h}), (\zeta_{1,h}, \xi_{1,h}) \in V_h \times V_h^0$ solve the following two coupled systems:
     \begin{align}
      ...
      \begin{align}\label{eq:Ah}
          \A_h((\zeta_h,\xi_h),(\psi_h,\eta_h)) &= a_h(\zeta_h, \xi_h) + \gamma^{\frac{1}{2}} (\Pi^0_{k,h} \psi_h, \Pi^0_{k,h} \xi_h) - \gamma^{\frac{1}{2}} (\Pi^0_{k,h} \zeta_h, \Pi^0_{k,h} \eta_h) \nonumber\\
          &\qquad+ a_h(\xi_h, \eta_h) + \beta(\Pi^0_{k,h} \xi_h, \Pi^0_{k,h} \eta_h).
      \end{align}
