...
\begin{lemma}\label{lem:err.est.cj}
    For $h < h_0$, and any $\epsilon > 0$, there exists a positive constant dependent on $\epsilon$ and independent of $h$ such that for $k = 1,2$, $\gamma > 0$, $1 \leq j \leq m$, and $h_0 = $,
    \begin{align}
