...
\begin{align}\label{u.simplyConnected}
  \bs{u} = \curl{\phi}.
\end{align}
...
\begin{enumerate}
    ...
    \item Find $\xi$ such that
          \begin{align}\label{eq:xi}
            (\curl{\xi}, \curl{\eta}) + \beta(\xi, \eta) = (\rho, \eta) \quad \forall \eta \in H_0^1(\Omega) \cap L_0^2(\Omega),    
          \end{align}
          or equivalently, find $\xi \in H_0^1(\Omega) \cap L_0^2(\Omega)$ such that
    ...
    \item Finally we find $\phi \in H^1(\Omega)$, or equivalently $\phi \in H^1(\Omega)$ such that
...
\begin{enumerate}
    \item Find $(\zeta, \xi) \in H^1(\Omega) \cap L_2^0(\Omega) \times H_0^1(\Omega) \cap L_0^2(\Omega)$ such that
    \begin{align}
      (\curl{\xi}, \curl{\psi}) + \gamma^{1/2}(\psi, \xi) &= \gamma^{-1/2} (\bs{f}, \curl{\psi}) \quad \forall \psi \in H^1(\Omega) \cap L_2^0(\Omega), \label{eq:P.mc.zeta}\\
      -\gamma^{1/2}(\zeta, \eta) + (\curl{\xi}, \curl{\eta}) + \beta(\xi, \eta) &= 0 \quad \forall \eta \in H_0^1(\Omega) \cap L_0^2(\Omega). \label{eq:P.mc.xi}
    \end{align}
    or equivalently, find $(\zeta, \xi)$ such that
